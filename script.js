Vue.component("Items", {
  ...
  template: `<div :class="{card:true,fender:brand == 'Fender',rogue:brand == 'Rogue',musicMan:brand == 'Music Man'}" >
            ...
            <div v-on:click = "activatePopUp">{{name}} </div>
             ...
             <div :class="{popUp:popUpActive,hidden:!popUpActive}" v-on:click = "activatePopUp">Name:{{name}} Brand:{{brand}} # of Strings:{{strings}} Price:'$'{{price}}<div v-on:click = "cartProcess" :class="{addToCartButton:true}">add to cart</div></div> 
            </div>`,
